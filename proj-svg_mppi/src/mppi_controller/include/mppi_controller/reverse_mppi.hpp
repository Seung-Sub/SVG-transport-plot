...
namespace cpu {
    ...
    private:
        ...
        const double Vx_cov_;                 //!< @brief covariance of steering angle noise
        // const double Vy_cov_;                 //!< @brief covariance of steering angle noise
        // const double Wz_cov_;                 //!< @brief covariance of steering angle noise
