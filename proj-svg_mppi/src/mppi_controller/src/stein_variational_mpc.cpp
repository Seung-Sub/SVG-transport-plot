...
namespace cpu {
    SteinVariationalMPC::SteinVariationalMPC(const Params::Common& common_params, const Params::SteinVariationalMPC& sv_mpc_params)
        : prediction_step_size_(static_cast<size_t>(common_params.prediction_step_size)),
          ...
          Vx_cov_(sv_mpc_params.Vx_cov),
        //   Vy_cov_(sv_mpc_params.Vy_cov),
        //   Wz_cov_(sv_mpc_params.Wz_cov),
          num_svgd_iteration_(sv_mpc_params.num_svgd_iteration),
          Vx_cov_for_grad_estimation_(sv_mpc_params.Vx_cov_for_grad_estimation),
        //   Vy_cov_for_grad_estimation_(sv_mpc_params.Vy_cov_for_grad_estimation),
        //   Wz_cov_for_grad_estimation_(sv_mpc_params.Wz_cov_for_grad_estimation),
        ...
        const std::array<double, CONTROL_SPACE::dim> control_cov_diag = {Vx_cov_};
...
#pragma omp parallel for num_threads(thread_num_)
        ...
        if (is_valid) {
            ...
            prior_samples_ptr_->random_sampling(prior_samples_ptr_->get_zero_control_seq(),
                                                prior_samples_ptr_->get_constant_control_seq_cov_matrices({Vx_cov_}));
    ...
    // void SteinVariationalMPC::set_obstacle_map(const nav_msgs::OccupancyGrid& obstacle_map) { mpc_base_ptr_->set_obstacle_map(obstacle_map); };

    void SteinVariationalMPC::set_reference_path(const nav_msgs::Path& reference_path) { mpc_base_ptr_->set_reference_path(reference_path); };

    void SteinVariationalMPC::set_single_goal(const geometry_msgs::PoseStamped& goal) { mpc_base_ptr_->set_single_goal(goal); };
