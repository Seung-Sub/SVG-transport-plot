...
namespace cpu {
    ForwardMPPI::ForwardMPPI(const Params::Common& common_params, const Params::ForwardMPPI& forward_mppi_params)
        ...
        //   Wz_cov_(forward_mppi_params.Wz_cov),
        ...
        //   Wz_cov_for_grad_estimation_(forward_mppi_params.Wz_cov_for_grad_estimation) 
        {
    ...
    // void ForwardMPPI::set_obstacle_map(const nav_msgs::OccupancyGrid& obstacle_map) { mpc_base_ptr_->set_obstacle_map(obstacle_map); };

    void ForwardMPPI::set_reference_path(const nav_msgs::Path& reference_path) { mpc_base_ptr_->set_reference_path(reference_path); };

    void ForwardMPPI::set_single_goal(const geometry_msgs::PoseStamped& goal) { mpc_base_ptr_->set_single_goal(goal); };
